  ...
  <v-row>
    ...
    <v-col cols="12">
      <v-card>
        ...
        <v-card-text> Use <code>dark</code> prop to switch table to the dark theme. </v-card-text>
        <demo-simple-table-dark />
      </v-card>
    </v-col>
    ...
    <v-col cols="12">
      <v-card>
        ...
        <v-card-text> You can show a dense version of the table by using the <code>dense</code> prop. </v-card-text>
        <demo-simple-table-dense />
      </v-card>
    </v-col>
    ...
    <v-col cols="12">
      <v-card>
        ...
        <v-card-text> Use the <code>height</code> prop to set the height of the table. </v-card-text>
